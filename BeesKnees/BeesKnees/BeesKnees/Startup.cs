...
using BeesKnees.Authorization;
using BeesKnees.Helpers;
using BeesKnees.ViewModels;
...
namespace BeesKnees
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("BeesKnees"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "BeesKnees API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "BeesKnees API V1");
            });
