...
namespace BeesKnees.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailer.SendEmailAsync(recepientName, recepientEmail, "Test Email from BeesKnees", message);
